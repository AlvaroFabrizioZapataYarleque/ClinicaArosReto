...
const { obtenerSolicitudes, crearSolicitud, actualizarEstadoSolicitud, obtenerSolicitudesUsuario, obtenerEstadoActualSolicitud } = require('../controllers/solicitudController');
...
router.get('/estado-actual', proteger, obtenerEstadoActualSolicitud);
